...
class TestHISLoginPage:
    ...
    def test_his_login_page(self, pandas_excel, browser_setup, execute_query):
        ...
        results.append(f'Expected Response: {url_status}')
        ...
        results.append(f'Expected Response: {username_status}')
        ...
        results.append(f'Expected Response: {password_status}')
        ...
        for row in result:
            ...
            results.append(f'Expected Response: {db_status}')

        ###################### Writing the Results to a New Excel Sheet ###############################

        data['Expected Response'] = results
